    ...
    <div class="col d-flex justify-content-center">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                <?php if ($_POST['max'] < 5 || in_array($_POST['page'], [1, 2])) { ?>
                    ...
                    <li class="page-item <?= $_POST['page'] == 4 ? 'active' : ''?> <?= $_POST['max'] < 4 ? 'disabled' : ''?>"><a class="page-link" href="/home?page=4<?= $search ? "&q={$search}" : '' ?>">4</a></li>
